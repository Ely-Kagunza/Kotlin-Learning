...
fun main() {
    ...
    val expensivePrices = prices.filter { price -> price > 300 }
    println("Prices greater than 300: $expensivePrices\n")
    // TODO 3: Map them to discounted prices (10% off)
    val discounts = expensivePrices.map { price -> price * 0.9}
    ...
    val averagePrice = menuItems.values.average()
